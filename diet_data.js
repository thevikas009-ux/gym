...
const FOOD_DB = [
  ...
  { id: "egg_boiled", group: "Breakfast & Snacks", name: "Whole Boiled Egg", cal: 70, protein: 6, carbs: 0.5, fiber: 0, unit: "egg" },
  { id: "egg_white", group: "Breakfast & Snacks", name: "Egg White", cal: 17, protein: 3.6, carbs: 0.2, fiber: 0, unit: "egg white" },
  { id: "peanut_butter_1tbsp", group: "Breakfast & Snacks", name: "Peanut Butter (1 tbsp)", cal: 95, protein: 4, carbs: 3, fiber: 1, unit: "tbsp" },
  { id: "sprouts_1bowl", group: "Breakfast & Snacks", name: "Moong Sprouts (1 Bowl)", cal: 100, protein: 7, carbs: 18, fiber: 4, unit: "bowl" },
  { id: "paneer_100g", group: "Breakfast & Snacks", name: "Raw Paneer (100g)", cal: 265, protein: 18, carbs: 3, fiber: 0, unit: "100g" },
...
const DIET_DATA = [
  ...
  },
  {
    ...
    options: [
      { tag: "veg", text: "1 Bowl Mixed Veg Soup + 2 Roti + Dal + Paneer / Sabzi" },
